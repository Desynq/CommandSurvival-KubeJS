...
const SigmaYetiBoss = (function () {
	...
	Class.prototype.register = function () {
		...
		this.server.runCommandSilent(`data modify entity ${this.entity.uuid.toString()} CustomName set value '{"color":"rainbow","bold":true,"text":"Sigma Yeti"}'`);
